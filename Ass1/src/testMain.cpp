...
int main(int , char **) {
        ...
        BaseCommand* cd = new CdCommand("/");
        BaseCommand* ls = new LsCommand("../../");
        BaseCommand* Mkdir = new MkdirCommand(" ../../././Dir2/Dir21/A/B");
        BaseCommand* Mkfile = new MkfileCommand("  ../././././././../Dir1/Dir11/Dir12/Amir   100      ");
        BaseCommand* Mkfile2 = new MkfileCommand("            /Dir1/Dir11/Amir 50");
        BaseCommand* Copy = new CpCommand(" /Dir1 /Dir2");
        BaseCommand* Mvfile = new MvCommand("../.././Dir2/.././Dir2 /Dir1");
        File File1("File1",3);
        File File2("File2",2);
        File File3("File3",1);
    ...
    DirRoot.removeFile("File2");FILE  Amir  50
DIR  Dir111  0
